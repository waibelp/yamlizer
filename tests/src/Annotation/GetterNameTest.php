...
/**
 * Class GetterNameTest
 *
 * @package Yamlizer\Tests\Annotation
 */
class GetterNameTest extends \PHPUnit_Framework_TestCase
{
    public function testAssignPropertyMetadata()
    {
        $annotation        = new GetterName();
        $annotation->value = 'someGettersMethodName';

        $propertyMetaData = new PropertyMetadata();
        $annotation->assignPropertyMetadata($propertyMetaData, $annotation);
        $this->assertEquals('someGettersMethodName', $propertyMetaData->getGetterName());
    }

    /**
     * @expectedException \Yamlizer\Exception\YamlizerException
     * @expectedExceptionMessage [GetterName] Method unknownGetterMethod of class Yamlizer\Tests\Entity\PrimitiveEntity does not exist!
     */
    public function testValidatePropertyMetadataInvalid()
    {
        ...
        $propertyMetadata = new PropertyMetadata();
        $propertyMetadata->setGetterName('unknownGetterMethod');
