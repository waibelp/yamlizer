...
/**
 * Class YamlizerAnnotation
 *
 * @package Yamlizer\Annotation
 */
abstract class YamlizerAnnotation
{
    public $value;
     ...
     */
    abstract public function assignPropertyMetadata(PropertyMetadata $propertyMetadata, YamlizerAnnotation $annotation);
